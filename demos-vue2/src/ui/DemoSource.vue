...
.demo-source__actions {
  ...
  margin-top: 12px;
  padding-top: 12px;
  border-top: 1px solid var(--pg-border, #e4e7ed);
}

.demo-source__btn {
  padding: 4px 12px;
  border: 1px solid var(--pg-border, #dcdfe6);
  border-radius: 4px;
  background: var(--pg-surface, #fff);
  color: var(--pg-muted, #909399);
  font-size: 13px;
  cursor: pointer;
...
.demo-source__btn:hover {
  color: var(--pg-accent, #409eff);
  border-color: var(--pg-accent, #409eff);
}

.demo-source__panel {
  margin-top: 12px;
  border: 1px solid var(--pg-border, #e4e7ed);
  border-radius: 6px;
  overflow: hidden;
  background: #f6f8fa;
}
...
.demo-source__tabs {
  ...
  padding: 0 8px;
  background: #fff;
  border-bottom: 1px solid var(--pg-border, #e4e7ed);
  overflow-x: auto;
}
...
.demo-source__tab--active {
  color: var(--pg-accent, #409eff);
  border-bottom-color: var(--pg-accent, #409eff);
}
...
.demo-source__code >>> .shiki,
.demo-source__code >>> .shiki span {
  background: transparent !important;
}
</style>
