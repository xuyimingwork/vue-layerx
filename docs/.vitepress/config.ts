      ...
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '弹层插槽怎么填', link: '/guide/cookbook/layer-template' },
            { text: '内容复用：页内 / Dialog / Drawer', link: '/guide/cookbook/content-reuse' },
            { text: '获取弹层结果', link: '/guide/cookbook/confirm' },
            { text: '存量弹窗渐进接入', link: '/guide/cookbook/legacy' },
            { text: '嵌套弹层', link: '/guide/cookbook/nested-self' },
          ],
        },
      ],
      '/api/': [
