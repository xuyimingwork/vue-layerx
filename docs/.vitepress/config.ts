      ...
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '§2 页内复用同一内容', link: '/guide/cookbook/compose' },
            { text: '§3 编辑与新建', link: '/guide/cookbook/edit' },
            { text: '§4 页内也要操作区', link: '/guide/cookbook/visible-outside' },
            { text: '§5 窄屏换 Drawer', link: '/guide/cookbook/adapt' },
